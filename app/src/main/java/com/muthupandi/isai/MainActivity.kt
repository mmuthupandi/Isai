...
/**
 * Isai's single [AppCompatActivity].
 *
...
class MainActivity : AppCompatActivity() {
    ...
    override fun onResume() {
        ...
        startService(
            Intent(this, IsaiService::class.java)
                .setAction(IsaiService.ACTION_START)
                .putExtra(IsaiService.INTENT_KEY_START_ID, IntegerTable.START_ID_ACTIVITY)
        )
    ...
    private fun startIntentAction(intent: Intent?): Boolean {
        ...
        val action =
            when (intent.action) {
                ...
                Isai.INTENT_KEY_SHORTCUT_SHUFFLE -> DeferredPlayback.ShuffleAll
                else -> {
