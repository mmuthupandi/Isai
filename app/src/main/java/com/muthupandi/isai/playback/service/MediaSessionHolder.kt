...
import com.muthupandi.isai.music.service.MediaSessionUID
import com.muthupandi.isai.music.service.toMediaDescription
...
import com.muthupandi.isai.util.newBroadcastPendingIntent
...
private class PlaybackNotification(
    ...
    init {
        setSmallIcon(R.drawable.ic_isai_24)
