...
package com.muthupandi.isai.playback.service
...
class ExoPlaybackStateHolder(
    ...
    private var loggedCurrentItem: Boolean = false
    ...
    private fun logPlayHistory(song: Song, durationListened: Long) {
        saveScope.launch {
            try {
                ...
                L.e(e, "Failed to log play history")
            }
        }
    }
    ...
    constructor(
        ...
        fun create(): ExoPlaybackStateHolder {
            // Since Isai is a music player, only specify an audio renderer to save
