 ...
 * FastScrollRecyclerView.kt is part of Isai.
 *
...
package com.muthupandi.isai.list.recycler
...
import com.muthupandi.isai.util.isRtl
import com.muthupandi.isai.util.isUnder
import com.muthupandi.isai.util.scale
 ...
 * Hai Zhang's AndroidFastScroll but slimmed down for Isai and with a couple of enhancements.
 *
 ...
 * - MODIFIER: Muthupandi [https://github.com/muthupandi]
 *
 * !!! MODIFICATIONS !!!:
 ...
 * - Use modified Isai resources instead of AFS resources
 ...
 * - Dynamic popups
 *
 * @author Hai Zhang, Alexander Capehart (Muthupandi)
 */
@SuppressLint("PrivateResource")
class FastScrollRecyclerView
@JvmOverloads
constructor(context: Context, attrs: AttributeSet? = null, @AttrRes defStyleAttr: Int = 0) :
    IsaiRecyclerView(context, attrs, defStyleAttr) {
    // Thumb
