 ...
 * IsaiService.kt is part of Isai.
 *
...
import com.muthupandi.isai.music.service.MusicServiceFragment
import com.muthupandi.isai.playback.service.PlaybackServiceFragment
...
class IsaiService :
    ...
    companion object {
        ...
        // This is only meant for Isai to internally ensure that it's state management will work.
