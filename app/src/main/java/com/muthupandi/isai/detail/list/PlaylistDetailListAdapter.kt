 ...
 * PlaylistDetailListAdapter.kt is part of Isai.
 *
...
import com.muthupandi.isai.databinding.ItemEditHeaderBinding
import com.muthupandi.isai.databinding.ItemEditableSongBinding
import com.muthupandi.isai.list.EditableListListener
import com.muthupandi.isai.list.Item
import com.muthupandi.isai.list.PlainHeader
import com.muthupandi.isai.list.adapter.PlayingIndicatorAdapter
...
import com.muthupandi.isai.list.recycler.MaterialDragCallback
...
class PlaylistDetailListAdapter(private val listener: Listener) :
    ...
    interface Listener : DetailListAdapter.Listener<Song>, EditableListListener {
        ...
        /** Called when the "add" option is selected in the edit header. */
        fun onAddSongs()
    }
...
private class EditHeaderViewHolder private constructor(private val binding: ItemEditHeaderBinding) :
    ...
    fun bind(editHeader: EditHeader, listener: PlaylistDetailListAdapter.Listener) {
        ...
        binding.headerAdd.apply {
            TooltipCompat.setTooltipText(this, contentDescription)
            setOnClickListener { listener.onAddSongs() }
        }
    }
    ...
    override fun updateEditing(editing: Boolean) {
        ...
        binding.headerEditHint.isVisible = editing
    }
