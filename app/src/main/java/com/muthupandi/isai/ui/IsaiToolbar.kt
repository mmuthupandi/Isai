 ...
 * IsaiToolbar.kt is part of Isai.
 *
...
package com.muthupandi.isai.ui
...
import com.muthupandi.isai.databinding.ViewToolbarBinding
...
constructor(
    ...
    private fun createActionButtonContext(itemId: Int): Context {
        val themeOverlayRes =
            when (itemId) {
                R.id.action_play -> R.style.ThemeOverlay_Isai_IconButton_Style_Small_Secondary
                R.id.action_shuffle -> R.style.ThemeOverlay_Isai_IconButton_Style_Small_Primary
                else -> 0
            }
