 ...
 * VolumeCompat.kt is part of Isai.
 *
...
import com.muthupandi.musikr.util.lazyReflectedMethod
...
internal val StorageVolume.mediaStoreVolumeNameCompat: String?
    get() =
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.R) {
            ...
            if (isPrimaryCompat) {
                // "primary_external" is used in all versions that Isai supports, is safe to use.
