 ...
 * JMetadataBuilder.cpp is part of Isai.
 *
...
jobject JMetadataBuilder::build() {
    JClassRef jPropertiesClass { env, "com/muthupandi/musikr/metadata/Properties" };
    ...
    JClassRef jMetadataClass { env, "com/muthupandi/musikr/metadata/Metadata" };
    jmethodID jMetadataInitMethod = jMetadataClass.method("<init>",
            "(Ljava/util/Map;Ljava/util/Map;Ljava/util/Map;[BLcom/"
                    "muthupandi/musikr/metadata/Properties;)V");
