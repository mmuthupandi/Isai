 ...
 * taglib_jni.cpp is part of Isai.
 *
...
static jobject metadataResultSuccess(JNIEnv *env, jobject metadata) {
    JClassRef jSuccessClass { env,
            "com/muthupandi/musikr/metadata/MetadataResult$Success" };
    jmethodID jInitMethod = jSuccessClass.method("<init>",
            "(Lcom/muthupandi/musikr/metadata/Metadata;)V");
...
static jobject metadataResultNoMetadata(JNIEnv *env) {
    return metadataResultObject(env,
            "com/muthupandi/musikr/metadata/MetadataResult$NoMetadata");
}

static jobject metadataResultNotAudio(JNIEnv *env) {
    return metadataResultObject(env,
            "com/muthupandi/musikr/metadata/MetadataResult$NotAudio");
}

static jobject metadataResultProviderFailed(JNIEnv *env) {
    return metadataResultObject(env,
            "com/muthupandi/musikr/metadata/MetadataResult$ProviderFailed");
}

extern "C" JNIEXPORT jobject JNICALL
Java_com_muthupandi_musikr_metadata_TagLibJNI_openNative(JNIEnv *env,
        jobject /* this */,
        jobject inputStream) {
