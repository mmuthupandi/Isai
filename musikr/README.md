...
Musikr is a highly opinionated multithreaded music loader that enables Isai's advanced music functionality.
...
Feel free to use this library as long as you follow Isai's GPLv3 license. Note that the license is viral, so
