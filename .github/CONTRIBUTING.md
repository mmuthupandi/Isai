...
## Crashes & Bugs
Log them in the [Issues](https://github.com/mmuthupandi/Isai/issues) tab.
...
If you have knowledge of Android/Kotlin in general, you could also go about fixing the bug yourself and opening a [Pull Request](https://github.com/mmuthupandi/Isai/pulls).

## Feature Requests
These should also be logged in the [Issues](https://github.com/mmuthupandi/Isai/issues) tab.
...
- **Will it be accepted?** Make sure the feature aligns with the core, rational philosophy of Isai as a simple, offline music player.
...
If you have the knowledge, you can also implement the feature yourself and create a [Pull Request](https://github.com/mmuthupandi/Isai/pulls), but its recommended that **you create an issue beforehand to give me a heads up.**
...
- Stick to general open-source contribution guidelines and avoid massive sweeping architectural changes without discussion.
